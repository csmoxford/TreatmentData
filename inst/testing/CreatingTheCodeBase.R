...
treatmentPlot$CreatePlot(xlim = c(0,50), numberRowsLegend = 2)
...
treatmentPlot$AddEvent(singleData, ypos = c(2/3,1))
treatmentPlot$AddEvent(singleData2, ypos = c(2/3,1))

# add the end of treatment event
treatmentPlot$AddEvent(EOTevent)

EOTevent@data$label = "EOT"
treatmentPlot$AddEventLabel(EOTevent,"label")
...
# Add the legend
treatmentPlot$AddLegend(itemsOnRow = 3, xoffset = 0.05)
